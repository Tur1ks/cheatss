...
public class ExperienceOrbRenderer extends EntityRenderer<ExperienceOrb> {
    ...
    public void render(ExperienceOrb pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        ...
        vertex(vertexconsumer, posestack$pose, -0.5F, -0.25F, i1, j1, k1, f, f3, pPackedLight);
        vertex(vertexconsumer, posestack$pose, 0.5F, -0.25F, i1, j1, k1, f1, f3, pPackedLight);
        vertex(vertexconsumer, posestack$pose, 0.5F, 0.75F, i1, j1, k1, f1, f2, pPackedLight);
        vertex(vertexconsumer, posestack$pose, -0.5F, 0.75F, i1, j1, k1, f, f2, pPackedLight);
        pPoseStack.popPose();
