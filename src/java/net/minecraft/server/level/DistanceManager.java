...
public abstract class DistanceManager {
    ...
    public boolean runAllUpdates(ChunkMap pChunkMap) {
        ...
        if (!this.chunksToUpdateFutures.isEmpty()) {
            this.chunksToUpdateFutures.forEach(holderIn -> holderIn.updateHighestAllowedStatus(pChunkMap));
            this.chunksToUpdateFutures.forEach(holderIn -> holderIn.updateFutures(pChunkMap, this.mainThreadExecutor));
